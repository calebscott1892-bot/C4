...
export const CASE_STUDIES = {
  'transform-fremantle': {
    ...
    thumbnail: '/portfolio/transform-fremantle/gallery-01-hero.png',
    ...
    screenshots: [
      { url: '/portfolio/transform-fremantle/gallery-01-hero.png', caption: 'Homepage — hero with harbour backdrop and mission introduction' },
      { url: '/portfolio/transform-fremantle/gallery-02-prayer-schedule.png', caption: 'Prayer meetings — weekly schedule across Fremantle churches' },
      { url: '/portfolio/transform-fremantle/gallery-03-unity-footer.png', caption: 'Unity in Essentials — ecumenical statement and branded footer' },
      { url: '/portfolio/transform-fremantle/gallery-04-statement-of-faith.png', caption: 'Statement of Faith — hero with Fremantle Town Hall' },
      { url: '/portfolio/transform-fremantle/gallery-05-vision-aim.png', caption: 'Vision & Aim — aerial Fremantle hero and vision statement' },
      { url: '/portfolio/transform-fremantle/gallery-06-aims-cards.png', caption: 'Our Aims — four numbered pillars of the movement' },
      { url: '/portfolio/transform-fremantle/gallery-07-resources.png', caption: 'Resources — downloadable PDF library with five documents' },
      { url: '/portfolio/transform-fremantle/gallery-08-connect.png', caption: 'Connect — contact form with phone and Instagram integration' },
      { url: '/portfolio/transform-fremantle/gallery-09-support.png', caption: 'Support — bank transfer details for direct giving' },
    ],
  ...
  'transform-hakea': {
    ...
    thumbnail: '/portfolio/transform-hakea/gallery-01-hero.png',
    ...
    screenshots: [
      { url: '/portfolio/transform-hakea/gallery-01-hero.png', caption: 'Hero — slideshow with prison backdrop and dual call-to-action' },
      { url: '/portfolio/transform-hakea/gallery-02-about.png', caption: 'About — mission statement and weekly prayer gathering introduction' },
      { url: '/portfolio/transform-hakea/gallery-03-prayer-card.png', caption: 'Prayer — schedule card with venue, time, and contact details' },
      { url: '/portfolio/transform-hakea/gallery-04-faq.png', caption: 'FAQ — animated accordion with practical questions for first-timers' },
      { url: '/portfolio/transform-hakea/gallery-05-vision-aims.png', caption: 'Vision & Aim — four numbered pillars of the movement' },
      { url: '/portfolio/transform-hakea/gallery-06-strategy.png', caption: 'Strategy — five-step plan for transformation' },
      { url: '/portfolio/transform-hakea/gallery-07-partnership.png', caption: 'Partnership — Prison Fellowship Australia collaboration' },
      { url: '/portfolio/transform-hakea/gallery-08-connect-cta.png', caption: 'Connect — crimson gradient CTA with Transform Freo cross-link' },
      { url: '/portfolio/transform-hakea/gallery-09-footer.png', caption: 'Footer — dark branded footer with contact, navigation, and partnership' },
    ],
