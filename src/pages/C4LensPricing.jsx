...
import { c4LensPackages, CTA_ROUTE } from '../data/pricing';

export default function C4LensPricing() {
  return (
    <div style={{ backgroundColor: 'var(--c4-bg)', color: 'var(--c4-text)' }}>
      <ServicePageHero
        ...
        description="Professional visual content for brands that demand precision and atmosphere."
      />
