        ...
        <div className="max-w-[560px] mx-auto px-6">
          ...
          >
            ...
            <p className="mt-3 text-[14px] leading-[1.6]" style={{ color: 'var(--c4-text-muted)' }}>
              We'll reply within 24 hours with next steps. Thanks for reaching out.
            </p>
          </motion.div>
        </div>
      </div>
    ...
    <div className="min-h-screen pt-28 md:pt-36 pb-24" style={{ backgroundColor: 'var(--c4-bg)' }}>
      <div className="max-w-[620px] mx-auto px-6">
        ...
        >
          ...
          {serviceLabel && (
            <p className="mt-3 text-[14px] leading-[1.6]" style={{ color: 'var(--c4-text-muted)' }}>
              You're inquiring about <span className="font-medium" style={{ color: 'var(--c4-text)' }}>{serviceLabel}</span>. Tell us more below.
            </p>
          )}
          {!serviceLabel && (
            <p className="mt-3 text-[14px] leading-[1.6]" style={{ color: 'var(--c4-text-muted)' }}>
